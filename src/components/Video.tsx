...
export function Video({ lessonSlug }: VideoProps) {
  ...
  if (!data || !data.lesson) {
    return (
      <div className="flex-1 items-center justify-center pt-[350px]">
        <Spinner size={40} />
        <p className="flex items-center justify-center pt-4 text-xl">
          Loading...
        </p>
      </div>
    );
          ...
          <div className="flex-1">
            ...
            {data.lesson.teacher && (
              <div className="flex items-center gap-4 mt-6">
                <img
                  className="h1-16 w-16 rounded-full border-2 border-blue-500"
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          >
            ...
            <div className="py-6 leading-relaxed">
              ...
              <p className="text-sm text-gray-200 mt-2">
                Acesse e utilize wallpapers exclusivos do evento!
              </p>
            </div>
            <div className="h-full p-6 flex items-center">
              <CaretRight size={24} />
